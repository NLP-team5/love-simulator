...
class TestRankingEndpoints:
    ...
    def test_ranking_order(self, client):
        ...
        rankings = [
            {'scenario_title': '친구에서 연인으로 (여사친)', 'nickname': 'Player1', 'score': 70},
            {'scenario_title': '친구에서 연인으로 (여사친)', 'nickname': 'Player2', 'score': 90},
            {'scenario_title': '친구에서 연인으로 (여사친)', 'nickname': 'Player3', 'score': 80},
        ]
